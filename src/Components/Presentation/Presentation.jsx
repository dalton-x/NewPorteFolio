          ...
          <div className="textIntro">
            ...
            <div className="row">
              <div className="col-lg-6 col-md-12">
                <div className="card my-5 bg-light h-100">
              ...
              <div className="col-lg-6 col-md-12">
                <div className="card mt-lg-5 mt-md-2 bg-light h-50">
                  <div className="card-header text-center">
                    <strong>
                  ...
                  <div className="card-body height text-center">
                    ...
                    <div className="progress mb-2" role="progressbar"
                          ...
                          aria-valuemax="100">
                      <div className="progress-bar progress-bar-striped bg-warning" style={{ width: '89%' }}></div>
                    </div>
                ...
                <div className="card bg-light h-50">
                  <div className="card-header text-center">
                    <strong>
                  ...
                  <div className="card-body text-center">
                    ...
                    <div className="progress mb-2" role="progressbar"
                          ...
                          aria-valuemax="100">
                      <div className="progress-bar progress-bar-striped bg-danger" style={{ width: '70%' }}></div>
                    </div>
